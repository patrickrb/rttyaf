 ...
 * [FT8AFBottomSheet] — the fix for the band picker not closing on Android Back
 * (issue #201).
 *
...
class FT8AFBottomSheetBackTest {
    ...
    fun backPress_whenHidden_propagatesToAppHandler_notSheet() {
        ...
        addAppHandler { appHandled = true }
        composeRule.setContent {
            FT8AFBottomSheet(visible = false, onDismiss = { dismissed = true }) {}
        }
        composeRule.waitForIdle()
